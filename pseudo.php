                ...
                <div id="post">
                    ...
                    <?php require_once 'php/pdo.php';
                        ...
                        if(isset($_POST['search'])){
                            $search = $_POST['search'];
                            $results = $database->prepare('SELECT * FROM user LEFT JOIN meow ON user_id = meow_id WHERE :pseudo = user_username AND meow_title LIKE :search OR meow_content LIKE :search
