                ...
                <div id="post">
                    ...
                    <?php require_once '../php/pdo.php';
                        ...
                        if(isset($_POST['search'])){
                            $search = $_POST['search'];
                            $results = $database->prepare('SELECT * FROM meow INNER JOIN user ON meow_userid = user_id WHERE meow_userid = :session AND meow_content LIKE :search
                            ...
                            <article class="tag" data-value="<?=$user['meow_tag']?>">
                                <div class="top-post">
                                    ...
                                    <div class="info">
                                        <div>
                                            <a ref="pseudo.php?pseudo=<?=$user['user_username'];?>"><img class="profile_pic" src="../profile_pic/<?=$user['user_pic'];?>" alt="profile_user"></a>
                                    ...
                                    <div class="remove-border">
                                        ...
                                        <div class="confirm-button">
                                            <form action="../php/delete.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <button type="submit" class="yes button" name ="delete" value="<?=$user['meow_id'];?>">Yes</button>
                                            </form>
